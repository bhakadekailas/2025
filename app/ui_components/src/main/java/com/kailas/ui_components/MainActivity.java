...
public class MainActivity extends AppCompatActivity {
    Button button_simple_demo, button_check_box_demo, button_radio_button_demo,
            ...
            button_progress_bar_demo, button_auto_complete_text_view_demo, button_dialog_box, button_alert_dialog,
    ...
    private void setClickListenersToAllViews() {
        ...
        button_dialog_box.setOnClickListener(view -> {
            Intent intent = new Intent(MainActivity.this, MyDialogBox.class);
            startActivity(intent);
        });
    ...
    private void initViews() {
        ...
        button_dialog_box = findViewById(R.id.button_dialog_box);
